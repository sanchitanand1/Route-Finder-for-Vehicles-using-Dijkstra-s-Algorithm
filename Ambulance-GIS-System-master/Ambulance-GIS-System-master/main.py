...
var = StringVar()
var.set("PCMC")
data=("PCMC", "Baner", "Kondhwa", "Bibwewadi","Kothrud","ShivajiNagar","VimanNagar","BalajiNagar","Hinjewadi","Hadapsar")



lbl = Label(window, text="RAV BEST ROUTES", fg='black', font=("Helvetica", 20), bg='light blue')
lbl.place(x=70, y=20)
...
window.title('RAV Route Finding System')
